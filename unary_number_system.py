...
# Saving the converted audio in a mp3 file named digits_count
...
while(num!=0):
    ...
    #We will take average of 100 frames
    while count<100:
        ret, img = cap.read()

        #Converting particular frame to grayscale 
...
# Saving the converted audio in a mp3 file named answer
